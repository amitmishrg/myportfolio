...
export const site = {
  ...
  hero: {
    ...
    subline:
      "Staff engineer, eleven years in. I build full agentic AI products — from the design system up to the streaming chat. Most recently Talos at Axiamatic: a chat workspace with artifacts, design mode, and live previews.",
  },
  marquee: [
    "WEB ENGINEERING",
    "DESIGN SYSTEMS",
  ...
  about: {
    title: "About",
    lead: "Staff frontend engineer, eleven years in. Still genuinely excited about the work.",
    body: [
